...
export function dark(): Recipe {
  return recipe('Dark poster', 'dark', buildLayers({
    ...
    roads: { shields: { on: false, fill: '#3E8E4F', text: '#0B0E13', everyMm: 150 }, stroke: '#FFB454', strokeWidthMm: 0.45 },
...
export function vintage(): Recipe {
  return recipe('Vintage atlas', 'vintage', buildLayers({
    ...
    roads: { shields: { on: false, fill: '#4A6B4F', text: '#F3EAD8', everyMm: 150 }, stroke: '#A6503C', strokeWidthMm: 0.5 },
...
export function retro(): Recipe {
  return recipe('Sextiotal', 'retro', buildLayers({
    ...
    roads: { shields: { on: false, fill: '#3E7A4E', text: '#F5E9D0', everyMm: 150 }, stroke: '#D95B43', strokeWidthMm: 0.5, casing: { on: true, color: '#F5E9D0', extraMm: 0.14 } },
